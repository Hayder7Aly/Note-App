...
executables=[cx_Freeze.Executable('notes_app.py',base=base,icon='icons.ico')]

cx_Freeze.setup(
    name='CALCULATOR APP',
    options={'build_exe':{'packages':['tkinter','os'],'include_files':['icons.ico','tcl86t.dll','tk86t.dll','icons2']}},
    version='0.01',
